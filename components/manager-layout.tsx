...
const notifications = [
  { id: 1, title: "Team update", message: "New tester assigned to your team", time: "2 hours ago", read: false },
  { id: 2, title: "Client escalation", message: "Tech Corp raised a priority ticket", time: "5 hours ago", read: false },
  { id: 3, title: "Workflow complete", message: "Network audit completed successfully", time: "1 day ago", read: true },
  { id: 4, title: "Report ready", message: "Weekly summary available", time: "2 days ago", read: true },
  { id: 5, title: "New assignment", message: "Cloud Security project assigned", time: "3 days ago", read: true },
]
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuLabel>
                  <div className="flex flex-col">
                    <span className="font-medium">Manager User</span>
                    <span className="text-xs text-gray-500 font-normal">manager@necurity.com</span>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
