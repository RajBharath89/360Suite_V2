...
import { Building2, CheckCircle, XCircle, Clock, Shield, Settings } from "lucide-react"
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      ...
      <Card className="bg-gradient-to-br from-amber-50 to-amber-100 border-amber-200 shadow-sm p-3">
        <CardContent className="px-2 py-1.5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">Professional</p>
              <p className="text-xl font-bold text-amber-600">{summaryStats.professional}</p>
            </div>
            <div className="h-8 w-8 bg-white/80 rounded-full flex items-center justify-center shadow-sm">
      ...
      <Card className="bg-gradient-to-br from-cyan-50 to-cyan-100 border-cyan-200 shadow-sm p-3">
        <CardContent className="px-2 py-1.5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-gray-600">Enterprise</p>
              <p className="text-xl font-bold text-cyan-600">{summaryStats.enterprise}</p>
            </div>
            <div className="h-8 w-8 bg-white/80 rounded-full flex items-center justify-center shadow-sm">
        ...
        <CardContent className="px-2 py-1.5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl font-bold text-teal-600">{summaryStats.standard}</p>
            </div>
            <div className="h-8 w-8 bg-white/80 rounded-full flex items-center justify-center shadow-sm">
