...
const profileData = {
  firstName: "Admin",
  lastName: "User",
  email: "admin@necurity.com",
  phone: "+91 98765 43210",
  department: "Security Operations",
  role: "System Administrator",
  employeeId: "EMP-001",
  joinDate: "Jan 15, 2023",
  lastLogin: "Dec 11, 2025, 10:30 AM",
  status: "Active"
}
...
export default function AdminProfile({ onBack }: AdminProfileProps) {
  ...
  const avatarOptions = [
    { id: "au", label: "AU", color: "bg-cyan-600" },
    { id: "ad", label: "AD", color: "bg-blue-600" },
    { id: "sa", label: "SA", color: "bg-green-600" },
    { id: "ne", label: "NE", color: "bg-purple-600" },
  ]
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <div className="w-20 h-20 rounded-full bg-cyan-600 flex items-center justify-center text-white text-2xl font-semibold">
                  {selectedAvatar ? avatarOptions.find(a => a.id === selectedAvatar)?.label : "AU"}
                </div>
                <button 
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge className="bg-cyan-100 text-cyan-700">Admin</Badge>
                </div>
              </div>
            </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="flex items-center gap-2">
                        <Calendar className="h-4 w-4 text-gray-400" />Employee ID
                      </Label>
                      <p className="text-gray-900 font-medium">{profileData.employeeId}</p>
                    </div>
                    <div className="space-y-2">
                      <Label className="flex items-center gap-2">
                        <Calendar className="h-4 w-4 text-gray-400" />Join Date
                      </Label>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 bg-cyan-50 rounded-lg text-center">
                      ...
                      <p className="text-2xl font-bold text-cyan-600">{systemStats.totalUsers}</p>
                    ...
                    <div className="p-4 bg-blue-50 rounded-lg text-center">
                      ...
                      <p className="text-2xl font-bold text-blue-600">{systemStats.totalServices}</p>
                      <p className="text-sm text-gray-600">Total Services</p>
                    </div>
                    <div className="p-4 bg-amber-50 rounded-lg text-center">
                      <AlertCircle className="h-6 w-6 text-amber-600 mx-auto mb-2" />
                      <p className="text-2xl font-bold text-amber-600">{systemStats.pendingApprovals}</p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <div>
                        <p className="font-medium text-sm">Dec 10, 2025 at 2:30 PM</p>
                        <p className="text-xs text-gray-500">Firefox on MacOS • Chennai, India</p>
                      </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">When a new user registers</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">When items need your approval</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      <p className="font-medium text-sm">License Expiry</p>
                      <p className="text-xs text-gray-500">When client licenses are expiring</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="font-medium">Dec 1, 2025</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
          ...
          <div className="space-y-4 py-4">
            <div className="flex justify-center gap-4">
              {avatarOptions.map((avatar) => (
                <button
                  ...
                  className={`w-16 h-16 rounded-full ${avatar.color} flex items-center justify-center text-white text-lg font-semibold ring-offset-2 transition-all ${selectedAvatar === avatar.id ? 'ring-2 ring-cyan-600' : 'hover:ring-2 hover:ring-gray-300'}`}
                >
                  {avatar.label}
                </button>
              ))}
            ...
            <div className="flex justify-center">
              ...
              <label
                ...
                className="px-4 py-2 border border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-cyan-500 hover:bg-cyan-50 transition-colors text-sm text-gray-600"
              >
                Choose File
              </label>
            </div>
