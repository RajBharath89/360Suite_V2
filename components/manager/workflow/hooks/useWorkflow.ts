...
import { mockClients } from '../../../admin/client-management/data/mock-data'
...
export function useWorkflow() {
  ...
  const reassignService = useCallback((serviceId: string, clientId: string, version: number) => {
    toast({
      title: "Service Reassigned",
      description: `New version ${version} has been created. Returning to Stage 6.`,
    })
  }, [toast])
