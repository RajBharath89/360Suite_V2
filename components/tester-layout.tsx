...
const notifications = [
  { id: 1, title: "New task assigned", message: "Web Application Security test", time: "2 hours ago", read: false },
  { id: 2, title: "Task deadline", message: "Cloud Security assessment due tomorrow", time: "5 hours ago", read: false },
  { id: 3, title: "Review requested", message: "Please review findings for API Security", time: "1 day ago", read: true },
]
      ...
      <div className="flex flex-col h-screen bg-gray-50">
        <header className="w-full flex items-center justify-between px-6 py-3 bg-gradient-to-r from-[#0d9488] to-[#0891b2] text-white shadow-md">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm font-medium text-white">Tester Dashboard</span>
          </div>
              ...
              <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuLabel>
                  <div className="flex flex-col">
                    <span className="font-medium">Tester User</span>
                    <span className="text-xs text-gray-500 font-normal">tester@necurity.com</span>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
